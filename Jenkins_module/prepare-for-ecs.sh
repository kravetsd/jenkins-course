#!/bin/bash
##installing any additional softeware here (as an example I install GIT):
...
mkdir -p /var/log/ecs /var/lib/ecs/data /etc/ecs /data /var/jenkins_home
chmod  o+w /var/jenkins_home/
chown -R 1000:1000 /data


## Write ECS config file PLEASE NOTE: ECS_CLUSTER should be your cluster name. In my case it is 'Jenkins'
